...
@RestController
@RequestMapping("/personas") //me va a permitir para get,post,put y delete
@CrossOrigin(origins = "*")
...
//PersonaServices servicio;
    ...
    private PersonaServices presonaServices;

    public PersonaController(PersonaServices personaServices){
        this.presonaServices = personaServices;
    }
    ...
    @PostMapping("")  //este metodo va a estar relacionado con post
